...
class PlcMonitorEngine:
    ...
    def load_registry(self, registry_path: str | Path | None = None):
        """Load variable registry from JSON file (generated by plc_var_scanner.py)."""
        ...
        for idx, (name, plc_type) in enumerate(raw.items()):
            self.registry[idx] = {"name": name, "plc_type": plc_type}
